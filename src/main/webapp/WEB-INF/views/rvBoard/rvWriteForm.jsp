...
$(document).ready(function() {
	$("#rvTitle").focus();
	 ...
	 $('#upload').on('click', function () {
		    ...
		    var fileCheck = document.getElementById("rvFile").value;
		    if(!fileCheck){
		        alert("파일을 올려주세요.");
		        return false;
		    }
    ...
    <div style="width:50px; height:50px"></div>    
        <div class="main-form">
	        ...
	        <form name="writeForm" id="writeForm" method="post" enctype="multipart/form-data">    
		            	<input type="text" style="color: #191919; width: 100%; margin-bottom:20px;" id="rvTitle" name="rvTitle" placeholder="제목을 입력해주세요.">
		         ...
		         <div style="text-align: left; margin-top:20px;">
		            ...
		            <input type="file" id="rvFile" name="rvFile">
